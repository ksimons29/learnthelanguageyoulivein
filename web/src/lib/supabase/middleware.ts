 ...
 * Supabase Middleware
 *
 * Refreshes Supabase auth sessions for Server Components.
 * Must be used in middleware.ts to maintain authentication state.
 */
...
export async function updateSession(request: NextRequest) {
  ...
  // For now, allow all pages to be viewed for testing
  // TODO: Uncomment to enable route protection after testing
